...
alt + shift + c
*/ 
-- cusor가 깜박거릴때 ctrl + enter : 선택된 줄만 실행
-- 나의 계정 보기
show user;
...
-- 오라클12버전 부터 일반사용자는 c##을 붙여 이름을 작명한다
-- create user user1 identified by 00000;
create user c##user1 identified by user00000;  
create user c##user2 identified by "00000";
...
--[표현법]drop user 사용자명 cascade; => 테이블이 있는 상태
